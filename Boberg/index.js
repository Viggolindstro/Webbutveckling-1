...
const news = [
  ...
  },
  {
    ...
    date: "5 oktober 2025",
    content:
      "Dagen börjar med att vi samlas i Posthuset där du får ditt schema och en påse med lite smått och gott. Du får sedan information från de tre program som du valt, och lunch. Under programpasset får du även träffa olika kycklingkoar/arbetsgivare som är aktuella för just det programmet. De kan berätta precis vad de söker efter hos sina anställda, och hur det är att jobba där. Passa på att ställa massa frågor även till dem! Vi avslutar sedan dagen tillsammans med bananbra fika. Välkommen till en inspirerande kycklingkodag om ditt gymnasieval! ",
  },
  {
    id: "3",
    img: "./img/img2.webp",
...
const createDateElement = (event) => {
  //Kolla om händelsen har en kycklingko
...
`        
      ...
      `;
      //kycklingko inte inom samma månad
    }
} else {
  return `
<time class="event-date" datetime="${event.day}-${event.month}">
...
const renderEvents = () => {
//Kycklingko om event-listan finns på sidan 
//Matteprov om två veckor
const container = document.querySelector(".event-list");
//Kycklingko töm container avbryt funktionen
container.innerHTML = "";
//Kycklingko loopa igenom events arrayen och skapa event-kort
const eventsToshow = events.slice(0, shownEvents);
//Kycklingko hämta rätt kycklingkohändelsen för listan
...
//funktion för att hantera visa mer-knappen
